...
- **Multi-action turns** — spend FP freely each turn
- **Species synergy** — full trio unlocks ultimate moves
- **Status effects** — Burn, Poison, Stun, Shield
- **Speed priority** — team SPD determines who goes first
- **3 game modes** — Tournament, Journey, Free Battle
- **Journey mode** — collect all 7 mythical fossils with scaling AI
